...
```{r join co2 popn}
cpop = left_join(co2l, popn, by=c('country','year')) # Error: cannot join on columns 'year' x 'year': Can't join on 'year' x 'year' because of incompatible types (integer / character) 
```
